...
app = FastAPI(title="NanoStability AI API", version="1.0.0")
...
# Load everything at module level — instant, no training on startup
...
@app.get("/")
def root():
    return {"status": "NanoStability AI API running", "model_ready": True}
...
def predict(req: PredictRequest):
    ...
    arr = np.array([[
        req.n_atoms, req.formation_energy_eV, req.homo_lumo_gap_eV,
